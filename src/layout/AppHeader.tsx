...
const AppHeader: React.FC = () => {
  ...
  const enterpriseKeys = ["AWW", "XYZ", "PQR"];
  ...
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      if ((event.metaKey || event.ctrlKey) && event.key === "k") {
        ...
        // Placeholder for future shortcut logic
      }
    };
    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-[99999] dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        <div
          ...
          } items-center justify-between w-full gap-4 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none flex-wrap`}
        >
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <Calendar
              ...
              panelClassName="dark:bg-gray-900 dark:text-white"
              showIcon
            />
