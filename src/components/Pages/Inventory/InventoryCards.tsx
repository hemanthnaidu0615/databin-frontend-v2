  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
      {cardData.map((card, index) => (
        <div
          key={index}
          className="group relative p-4 rounded-2xl bg-white dark:bg-gray-800 backdrop-blur-md transition-all duration-300 ease-in-out transform hover:scale-105"
        >
          {/* Border glow effect on hover */}
          <div
            className="absolute inset-0 rounded-2xl border-2 opacity-60 group-hover:opacity-100 group-hover:shadow-[0_0_15px] transition duration-300 pointer-events-none"
            style={{
