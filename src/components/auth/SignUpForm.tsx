...
function SignUp() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!validatePassword(password)) {
      setError(
        "Password must be 8–15 characters with 1 uppercase & 1 special symbol (@, #, ?)"
      );
      return;
    }
  ...
  return (
    <div className="relative w-full max-w-md">
      <div className="absolute inset-0 bg-gradient-to-r from-[#a855f7] to-[#a855f7] shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
          ...
          <div className="mx-auto">
            ...
            <div className="mb-2 text-xs">
              <ul className="space-y-0.5">
                ...
                >
                  {passwordValidations.upperCase ? "✔️" : "❌"} 1 uppercase
                  letter
                </li>
                <li
                  className={`${
            ...
            <button
              type="submit"
              className="bg-[#a855f7] text-white rounded-md px-4 py-2 w-full cursor-pointer"
            >
              Sign Up
            </button>
            ...
            <div className="mt-2 text-center text-sm">
              <p>
                ...
                <button
                  type="button"
                  className="border border-[#a855f7] px-4 py-2 rounded text-sm font-medium text-gray-700 cursor-pointer ml-2"
