...
const FulfillmentEfficiency: React.FC<FulfillmentEfficiencyProps> = ({
  ...
  const data = {
    weekly: [120, 90, 60, 45],  // Fulfillment stage counts (Picked, Packed, Shipped, Delivered)
    monthly: [480, 350, 220, 180], 
  };

  const categories = ["Picked", "Packed", "Shipped", "Delivered"];
  ...
  const apexOptions: ApexOptions = {
    ...
    colors: ["#4CAF50", "#FF9800", "#2196F3", "#F44336"], // Colors for each fulfillment stage
    plotOptions: {
  ...
  const series = [{ name: "Fulfillment Stages", data: data[timeFrame] }];
