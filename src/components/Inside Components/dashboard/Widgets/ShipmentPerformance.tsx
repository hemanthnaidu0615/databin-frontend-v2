...
const ShipmentPerformance: React.FC<ShipmentPerformanceProps> = ({
  ...
  const data = {
    weekly: [75, 50, 25, 20],  // Shipment count for each category
    monthly: [300, 200, 100, 80], 
  };

  const categories = ["On-Time", "Delayed", "In Transit", "Cancelled"];
  ...
  const apexOptions: ApexOptions = {
    ...
    colors: ["#4CAF50", "#FF9800", "#2196F3", "#F44336"], // Colors for each category
    plotOptions: {
  ...
  const series = [{ name: "Shipments", data: data[timeFrame] }];
